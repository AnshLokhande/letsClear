...
def remove_haze(HazeImg, airlightEstimation_windowSze=15, boundaryConstraint_windowSze=3, C0=30, C1=300,
                regularize_lambda=0.2, sigma=0.5, delta=0.85, showHazeTransmissionMap=True):
